...
public class Daos_Persona {
    ...
    public ArrayList<Persona> mostrarPersonas() {
    	...
    	String consulta = "select id_persona, email_persona, nombre_persona, apellido_persona from persona";
    	...
    	try {
			...
			while (rs.next()) {
				...
				persona.setNombre_Persona(rs.getString(3));
				persona.setApellido_Persona(rs.getString(4));
